...
const Submit = () => {
    ...
    return (
        <form onSubmit={submitHandler} className={`flex flex-col justify-between gap-4 h-full min-h-screen md:col-span-2 md:min-h-0 ${steps.currentStep === 5 && 'md:justify-center'}`}>
